...
struct matrix *render_box(double x0, double y0, double z0, double lx, double ly, double lz) {
	...
	add_edge(a, x0, y0, z0, x1, y0, z0);
	add_edge(a, x0, y0, z1, x1, y0, z1);
	add_edge(a, x0, y1, z0, x1, y1, z0);
	add_edge(a, x0, y1, z1, x1, y1, z1);
	add_edge(a, x0, y0, z0, x0, y1, z0);
	add_edge(a, x1, y0, z0, x1, y1, z0);
	add_edge(a, x0, y0, z1, x0, y1, z1);
	add_edge(a, x1, y0, z1, x1, y1, z1);
	add_edge(a, x0, y0, z0, x0, y0, z1);
	add_edge(a, x1, y0, z0, x1, y0, z1);
	add_edge(a, x0, y1, z0, x0, y1, z1);
	add_edge(a, x1, y1, z0, x1, y1, z1);
	return a;
}
