...
%token <string> CONSTANTS SAVE_COORDS CAMERA 
 ...
 /* ADDED PORTAL CODE HERE */
%token <string> SPHERE TORUS BOX LINE CS MESH TEXTURE PORTAL
%token <string> STRING
...
/* YET MORE PORTAL CODE!!!! */
PORTAL DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE DOUBLE {
  lineno++;
  op[lastop].opcode = PORTAL;
  op[lastop].op.portal.d[0] = $2;
  op[lastop].op.portal.d[1] = $3;
  op[lastop].op.portal.d[2] = $4;
  op[lastop].op.portal.d[3] = $5;
  op[lastop].op.portal.d[4] = $6;
  op[lastop].op.portal.d[5] = $7;
  op[lastop].op.portal.d[6] = $8;
  op[lastop].op.portal.d[7] = $9;
  op[lastop].op.portal.d[8] = $10;
  op[lastop].op.portal.d[9] = $11;
  op[lastop].op.portal.d[10] = $12;
  op[lastop].op.portal.d[11] = $13;
  op[lastop].op.portal.d[12] = $14;
  op[lastop].op.portal.d[13] = $15;
