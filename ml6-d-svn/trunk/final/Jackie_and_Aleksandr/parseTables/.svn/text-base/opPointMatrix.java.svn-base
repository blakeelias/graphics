...
public class opPointMatrix extends opMatrix {

    private int lastCol;

    public opPointMatrix() {
	super();
	lastCol = 0;
    }

    public opPointMatrix( int c ) {
	super( c );
	lastCol = 0;
    }
 ...
 public void renderCurve(double x1, double y1, double x2, double y2,
	...
	public void makeBox(double x, double y, double z, double xlength, double ylength, double zlength)
{

 	addEdge(x, y, z,x+xlength, y, z);
        addEdge(x, y, z, x, y+ylength, z);
        addEdge(x, y, z, x, y, z+zlength);
        addEdge(x+xlength, y+ylength, z+zlength,x, y+ylength, z+zlength);
        addEdge(x+xlength, y+ylength, z+zlength,x+xlength, y, z+zlength);
        addEdge(x+xlength, y+ylength, z+zlength,x+xlength, y+ylength, z);
        addEdge(x, y, z+zlength,x, y+ylength, z+zlength);
        addEdge(x, y, z+zlength, x+xlength, y, z+zlength);
        addEdge(x+xlength, y+ylength, z, x, y+ylength, z);
        addEdge(x+xlength, y+ylength, z,x+xlength, y, z);
        addEdge(x+xlength, y, z+zlength, x+xlength, y, z);
        addEdge(x, y+ylength, z+zlength,x, y+ylength, z);
...
public void run( opPointMatrix m, opFrame f, Stack <opPointMatrix> s){}
    public void append(opPointMatrix small){
        for(int col = 0; col < small.lastCol; col++)
            this.addPoint(small.m[0][col],
                          small.m[1][col],
                          small.m[2][col]);
}
...
/*	opPointMatrix temp= new opPointMatrix(); //attempt 1
	double t =0;
	int c = (int)(1/step);
	int d =0;
	int count=0;
	...
	opPointMatrix templong= new opPointMatrix();
	opPointMatrix templat= new opPointMatrix();
	int c=0;
	int d=0;
...
/*	opPointMatrix temp= new opPointMatrix();
    ...
    public opPointMatrix copy() {
	
	opPointMatrix n = new opPointMatrix( m[0].length );
