...
Inputs:  int rows
         int cols 
Returns: Once allocated, access the matrix as follows:
         m->m[r][c]=something;
         if (m->lastcol)... 
==========================================================*/
...
Returns: 1. free individual rows
...
Inputs:  struct matrix *m
         int newcols 
Returns: Reallocates the memory for m->m such that it now has
...
Returns: turns m in to an identity matrix
====================================================*/
...
/*===================== void zero_matrix() ==============
Inputs: struct matrix *m
Returns: turns m into the zero matrix
=======================================================*/
...
Inputs:  double x
         struct matrix *m 
Returns: multiply each element of m by x
===================================================*/
...
Inputs:  struct matrix *a
         struct matrix *b 
Returns: copy matrix a to matrix b: a and b must have the same number of rows
=============================================================================*/
