...
Inputs:   screen s
         ...
         int x
         int y 
Returns: Sets the color at pixel x, y to the color represented by c
...
/*======== void clear_screen() ==========
Inputs:   screen s  
Returns: Sets every color in screen s to black
...
Inputs:  screen s
         char *file 
Returns: Saves screen s as a valid ppm file using the
         settings in ml6.h
02/12/10 09:14:07
jdyrlandweaver
====================================*/
...
Inputs:   screen s
         char *file 
Returns: Saves the screen stored in s to the filename represented
         by file. 
...
/*============ void display() ===============
Inputs:   screen s 
Returns: Will display the screen s on your monitor
