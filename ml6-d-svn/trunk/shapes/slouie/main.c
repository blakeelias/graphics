...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, 255, f) != NULL ) {
    ...
    //printf(":%s:\n",line);
    char c;
    double x, y, z, x1, y1, z1, r, r2, step;
    int mode;
    ...
    case 'c':
      fgets(line, 255, f);
      sscanf(line, "%lf %lf %lf %lf", &r, &x, &y, &step);
      render_circle(pm, r, x, y, step);
      break;
    case 'm':
      fgets(line, 255, f);
      sscanf(line, "%lf %lf %lf", &r, &x, &y);
      render_sphere_mesh(pm, r, x, y, 0.025);
      break;
    case 'd':
      fgets(line, 255, f);
      sscanf(line, "%lf %lf %lf %lf", &r2, &r, &x, &y);
      render_torus_mesh(pm, r, r2, x, y,0.025);
      break;
    case 's':
      //printf("SCALE\n");
      fgets(line, 255, f);
