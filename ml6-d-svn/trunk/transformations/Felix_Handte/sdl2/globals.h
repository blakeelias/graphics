...
struct object {
	struct matrix *ac; // absolute control points
	struct matrix *rc; // relative control points
	struct matrix *ap; // absolute points
	struct matrix *rp; // relative points
	int *e;            // edges
	color c;           // color
};
